<ul class="breadcrumb">
    ...
    <li class="active"><?= ucfirst(htmlspecialchars($_GET['p'])) ?></li>
</ul>
<div class="row">
...
$form = new Form(substr(ucfirst(htmlspecialchars($_GET['p'])), 0, -1) . ' informations', 'administration/' . htmlspecialchars($_GET['p']) . '/search', 'true');
